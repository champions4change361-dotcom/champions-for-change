...
export const tournaments = pgTable("tournaments", {
  ...
  // COMPREHENSIVE SPORT-SPECIFIC TOURNAMENT CONFIGURATIONS
  ...
  soccerFormat: text("soccer_format", {
    enum: ["single-elimination", "group-stage-knockout", "round-robin", "home-away-series"]
  }),
  ...
  byeManagement: text("bye_management", {
    enum: ["automatic", "manual", "highest-seed", "random"]
  }),
  multiDayFormat: boolean("multi_day_format").default(false),
  sessionScheduling: jsonb("session_scheduling"),
  officialAssignments: boolean("official_assignments").default(false),
});
