...
**PRICING UPDATE (Aug 13, 2025)**: Unified pricing structure deployed across all platform components with domain-specific tiers. Education domain features 3-tier structure: Foundation (FREE - up to 3 tournaments/year + $25 suggested donation), Champion ($99/month or $990/year - unlimited tournaments + multi-school management), District Enterprise ($399/month or $3,990/year - white-label + custom domain + FERPA compliance). Business/Coaches domains feature 4-tier structure: Freemium (FREE - 3 tournaments/year), Tournament Credits ($15/tournament), Monthly Pro ($99/month), Annual Pro ($990/year). Creates proper freemium-to-paid conversion funnel for all user segments.
