...
export class UILEventManagementService {
  ...
  private readonly HIGH_SCHOOL_COMPETITIONS: UILCompetitionConfig[] = [
    ...
    // Additional High School Competitions to reach 50+ total
    {
      id: 'hs_lincoln_douglas_debate',
      name: 'Lincoln-Douglas Debate',
      category: 'lincoln_douglas_debate',
      competitionType: 'high_school',
      gradeLevel: '9-12',
      classification: ['high_1A', 'high_2A', 'high_3A', 'high_4A', 'high_5A', 'high_6A'],
      maxParticipants: 3,
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 6, teamAdvance: 0 },
      teksAlignment: 'English TEKS: Speaking and Listening, Critical Thinking',
      subjectArea: 'Speech and Debate',
      season: 'spring',
      isActive: true
    },
    {
      id: 'hs_congressional_debate',
      name: 'Congressional Debate',
      category: 'congressional_debate',
      competitionType: 'high_school',
      gradeLevel: '9-12',
      classification: ['high_1A', 'high_2A', 'high_3A', 'high_4A', 'high_5A', 'high_6A'],
      maxParticipants: 6,
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 6, teamAdvance: 0 },
      teksAlignment: 'English TEKS: Speaking and Listening, Government',
      subjectArea: 'Speech and Debate',
      season: 'spring',
      isActive: true
    },
    {
      id: 'hs_extemporaneous_speaking',
      name: 'Extemporaneous Speaking',
      category: 'extemporaneous_speaking',
      competitionType: 'high_school',
      gradeLevel: '9-12',
      classification: ['high_1A', 'high_2A', 'high_3A', 'high_4A', 'high_5A', 'high_6A'],
      maxParticipants: 3,
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 6, teamAdvance: 0 },
      teksAlignment: 'English TEKS: Speaking and Listening, Research',
      subjectArea: 'Speech and Debate',
      season: 'spring',
      isActive: true
    },
    {
      id: 'hs_original_oratory',
      name: 'Original Oratory',
      category: 'original_oratory',
      competitionType: 'high_school',
      gradeLevel: '9-12',
      classification: ['high_1A', 'high_2A', 'high_3A', 'high_4A', 'high_5A', 'high_6A'],
      maxParticipants: 3,
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 6, teamAdvance: 0 },
      teksAlignment: 'English TEKS: Speaking and Listening, Creative Expression',
      subjectArea: 'Speech and Debate',
      season: 'spring',
      isActive: true
    },
    {
      id: 'hs_duo_interpretation',
      name: 'Duo Interpretation',
      category: 'duo_interpretation',
      competitionType: 'high_school',
      gradeLevel: '9-12',
      classification: ['high_1A', 'high_2A', 'high_3A', 'high_4A', 'high_5A', 'high_6A'],
      maxParticipants: 6,
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 6, teamAdvance: 0 },
      teksAlignment: 'English TEKS: Reading/Comprehension, Performance',
      subjectArea: 'Speech and Debate',
      season: 'spring',
      isActive: true
    },
    {
      id: 'hs_humorous_interpretation',
      name: 'Humorous Interpretation',
      category: 'humorous_interpretation',
      competitionType: 'high_school',
      gradeLevel: '9-12',
      classification: ['high_1A', 'high_2A', 'high_3A', 'high_4A', 'high_5A', 'high_6A'],
      maxParticipants: 3,
    ...
    {
      id: 'hs_dramatic_interpretation',
      name: 'Dramatic Interpretation',
      category: 'dramatic_interpretation',
      competitionType: 'high_school',
      gradeLevel: '9-12',
      classification: ['high_1A', 'high_2A', 'high_3A', 'high_4A', 'high_5A', 'high_6A'],
      maxParticipants: 3,
    ...
    },
    {
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 6, teamAdvance: 0 },
      teksAlignment: 'English TEKS: Speaking and Listening, Research and Inquiry',
      subjectArea: 'Speech and Debate',
      season: 'spring',
      isActive: true
    },
    {
      id: 'hs_public_forum_debate',
      name: 'Public Forum Debate',
      category: 'public_forum_debate',
      competitionType: 'high_school',
      gradeLevel: '9-12',
      classification: ['high_1A', 'high_2A', 'high_3A', 'high_4A', 'high_5A', 'high_6A'],
      maxParticipants: 4,
    ...
    {
      id: 'hs_world_schools_debate',
      name: 'World Schools Debate',
      category: 'world_schools_debate',
      competitionType: 'high_school',
      gradeLevel: '9-12',
      classification: ['high_1A', 'high_2A', 'high_3A', 'high_4A', 'high_5A', 'high_6A'],
      maxParticipants: 6,
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 0, teamAdvance: 3 },
      teksAlignment: 'English TEKS: Speaking and Listening, Global Perspectives',
      subjectArea: 'Speech and Debate',
      season: 'spring',
      isActive: true
    },
    {
      id: 'hs_radio_broadcasting',
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 6, teamAdvance: 0 },
      teksAlignment: 'Journalism TEKS: Broadcasting and Media',
      subjectArea: 'Journalism',
      season: 'spring',
      isActive: true
    },
    {
      ...
      isTeamEvent: true,
      teamSize: 3,
      contestFormat: 'presentation',
      hasAdvancement: true,
      advancementRules: { individualAdvance: 0, teamAdvance: 3 },
      teksAlignment: 'Journalism TEKS: Broadcasting and Digital Media',
      subjectArea: 'Journalism',
      season: 'spring',
      isActive: true
    }
  ...
  private readonly APLUS_COMPETITIONS: UILCompetitionConfig[] = [
    ...
    // Additional A+ Competitions to reach 50+ total
    {
      id: 'aplus_modern_oratory',
      name: 'Modern Oratory',
      category: 'modern_oratory',
      competitionType: 'aplus',
      gradeLevel: '6-8',
      classification: ['middle'],
      maxParticipants: 3,
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 6, teamAdvance: 0 },
      teksAlignment: 'English TEKS: Speaking and Listening, Oral Communication',
      subjectArea: 'English Language Arts',
      season: 'spring',
      isActive: true
    },
    {
      id: 'aplus_music_memory',
      name: 'Music Memory',
      category: 'music_memory',
      competitionType: 'aplus',
      gradeLevel: '2-8',
      classification: ['elementary', 'middle'],
      maxParticipants: 3,
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 6, teamAdvance: 0 },
      teksAlignment: 'Fine Arts TEKS: Music History and Culture',
      subjectArea: 'Fine Arts',
      season: 'spring',
      isActive: true
    },
    {
      id: 'aplus_impromptu_speaking',
      name: 'Impromptu Speaking',
      category: 'impromptu_speaking',
      competitionType: 'aplus',
      gradeLevel: '5-8',
      classification: ['elementary', 'middle'],
      maxParticipants: 3,
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 6, teamAdvance: 0 },
      teksAlignment: 'English TEKS: Speaking and Listening, Communication',
      subjectArea: 'English Language Arts',
      season: 'spring',
      isActive: true
    },
    {
      id: 'aplus_storytelling',
      name: 'Storytelling',
    ...
    },
    {
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 6, teamAdvance: 0 },
      teksAlignment: 'Fine Arts TEKS: Art History and Culture',
      subjectArea: 'Fine Arts',
      season: 'spring',
      isActive: true
    },
    {
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 6, teamAdvance: 0 },
      teksAlignment: 'English TEKS: Spelling and Vocabulary',
      subjectArea: 'English Language Arts',
      season: 'spring',
      isActive: true
    },
    {
      id: 'aplus_ready_writing',
      name: 'Ready Writing',
      category: 'ready_writing',
      competitionType: 'aplus',
      gradeLevel: '4-8',
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 6, teamAdvance: 0 },
      teksAlignment: 'English TEKS: Writing Process and Expression',
      subjectArea: 'English Language Arts',
      season: 'spring',
      isActive: true
    },
    {
      id: 'aplus_social_studies',
      name: 'Social Studies',
      category: 'social_studies',
      competitionType: 'aplus',
      gradeLevel: '4-8',
      ...
      hasAdvancement: true,
      advancementRules: { individualAdvance: 6, teamAdvance: 0 },
      teksAlignment: 'Social Studies TEKS: History, Geography, Economics, Government',
      subjectArea: 'Social Studies',
      season: 'spring',
      isActive: true
    }
